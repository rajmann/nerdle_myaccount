...
import { setGamesPlayedToday } from '../../lib/gameTracker'
...
export const WinModal = ({
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      setGamesPlayed(setGamesPlayedToday(gameMode))
  ...
  //NERDLE CUP
  var cupUrlParams = JSON.parse(localStorage.getItem('cupUrlParams')||'{}')
  ...
  return (
    <>
      <Transition.Root show={isOpen || thisOpen} as={Fragment}>
        ...
        >
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-24 text-center sm:block sm:p-0 winModalOld" id="winModalOld">
            <Transition.Child
              as={Fragment}
              ...
              <div className="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                ...
                <div>
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div id="winSection" className="relative">
                      ...
                      <div className="mt-5 sm:mt-4 text-center">
                        ...
                        >
                          {gameMode === 'pro' ? 'Share result' : 'Share'}
                        </button>
                      </div>
                      ...
                      {gameMode !== 'pro' && LBLToken === '' && (
                        <div className="mt-2 sm:mt-2 text-center">
                          {/* <button
                    type="button"
                    className="text-center w-[320px] mx-auto inline-flex justify-center w-full rounded-md border border-transparent shadow-sm pb-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:text-sm"
                    onClick={() => {
                      ...
                      handleLBLLogin(scorePayload, 1)
                    }}
                  >
                    <div className="text-center">
                      <img
                        src="/leaderboardle-banner-min.png"
                        alt="leaderboard"
                        className="mx-auto mb-1"
                      />
                      Login and share to LeaderboardLe
                    </div>
                  </button> */}
                  ...
                  >
                    If the LeaderboardLe login fails click here
                  </div> */}
                        </div>
                      )}
                      ...
                      <div id="moreGamesSection">

                        <p className={"pt-2 text-m cursor-pointer text-center dark:text-[#D7DADC] " + (lastUnplayedDate == "" ? "mt-2" : "")}>
                          <a
                ...
                >
                  ...
                  <div style={{flex: "0 0 auto", width:'100%'}}>
                    <a href="https://nerdlegame.com/s/targets" className="no-decoration"
                      onClick={() => {
                        const var1Clicked = localStorage.getItem('exp1var1Clicked')
                        if (!var1Clicked) {
                          localStorage.setItem('exp1var1Clicked', 'true')
                          ...
                          if (lastPlayedCount == 1) {
                            // what game was it?
                            const lastPlayedGame = Object.keys(lastPlayedObject)[0]
                            handleLogEvent('exp1_var1_clicked_' + lastPlayedGame)
                          } else {
                            // not just classic
                            handleLogEvent('exp1_var1_clicked_MG')
                          }

                          handleLogEvent('exp1_var1_clicked')
                        }
                      }}
                    >
                        <div className="n-big-card" >
                            <div className="n-big-card-content">
                                <div className="n-big-card-title" style={{"borderRadius": "6px 6px 0px 0px", "backgroundColor":"#046552"}}>
                                    <p>new: match the Targets</p>
                                </div>

                                <div className="n-big-card-description">

                                    <img src="https://www.nerdlegame.com/assets/images/card-targets.png" className="img-fluid" />

                                    <div className="n-big-card-play-button" >play</div>
                                </div>
                            </div>
                        </div>
                    </a>
                  ...
                  <p><a className="cursor-pointer underline" href="https://www.nerdlegame.com/"
                    onClick={() => {
                      const var1Clicked = localStorage.getItem('exp1var1Clicked')
                      if (!var1Clicked) {
                        localStorage.setItem('exp1var1Clicked', 'true')
                ...
                >
                  ...
                  <div style={{flex: "0 0 auto", width:'100%'}}>
                    <a href="https://quad.nerdlegame.com" className="no-decoration"
                      onClick={() => {
                        const var1Clicked = localStorage.getItem('exp1var2Clicked')
                        if (!var1Clicked) {
                          localStorage.setItem('exp1var2Clicked', 'true')
                          ...
                          if (lastPlayedCount == 1) {
                            // what game was it?
                            const lastPlayedGame = Object.keys(lastPlayedObject)[0]
                            handleLogEvent('exp1_var2_clicked_' + lastPlayedGame)
                          } else {
                            // not just classic
                            handleLogEvent('exp1_var2_clicked_MG')
                          }

                          handleLogEvent('exp1_var2_clicked')
                        }
                      }}
                    >
                        <div className="n-big-card" >
                            <div className="n-big-card-content">
                                <div className="n-big-card-title" style={{"borderRadius": "6px 6px 0px 0px", "backgroundColor":"#046552"}}>
                                    <p>4 nerdles at once!</p>
                                </div>

                                <div className="n-big-card-description">

                                    <img src="https://www.nerdlegame.com/assets/images/tile-quad.png" className="img-fluid" />
