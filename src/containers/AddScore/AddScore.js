...
const AddScore = () => {
  ...
  return (
    <>
      <button
        className="fixed bottom-20 right-11 h-14 w-14 rounded-full bg-nerdle-primary p-3 hover:bg-nerdle-secondary focus:outline-none focus-visible:ring-2 focus-visible:ring-nerdle-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background z-[9999]"
